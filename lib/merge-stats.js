...
(function (root, factory) {
  ...
  var STREAK_KEYS = ['clStreak', 'cineclueStreak', 'cineframeStreak', 'cinecastStreak', 'cineplotStreak'];
  var STATE_KEYS = ['cineclueState', 'cineframeState', 'cinecastState', 'cineplotState'];
